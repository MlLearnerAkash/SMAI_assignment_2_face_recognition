...
name = f"{args.mode}_{args.initialization}_{args.lr}_{device.type}"
# Initialize Weights & Biases
wandb.init(project='resnet18-classification-2', config=args, name=name)
config = wandb.config
...
def initialize_model(pretrained=True):
    if args.mode == "vgg_face":
        model = vgg_face_dag("/home/akash/ws/personal/SMAI_assignments/assignment_2/vgg_face_dag.pth")
        # layers_to_freeze = ["conv1_1", "conv1_2", "conv2_1"]
